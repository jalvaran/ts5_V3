 ...
 */
function BajaAltaInsumo(){
    var idBoton= 'BtnEjecutar';
    ...
    var Observaciones = document.getElementById('TxtObservacionesInsumo').value;
    if(TipoMovimiento==''){
        alertify.alert("Debe seleccionar un tipo de movimiento");
        document.getElementById(idBoton).disabled=false;   
        document.getElementById(idBoton).value="Ejecutar";
        document.getElementById('TipoMovimiento').style.backgroundColor="pink";
        return;
    }else{
        
        document.getElementById('TipoMovimiento').style.backgroundColor="";
    }
    if(Observaciones==''){
        alertify.alert("Debe escribir Observaciones");
        document.getElementById(idBoton).disabled=false;   
        document.getElementById(idBoton).value="Ejecutar";
        document.getElementById('TxtObservacionesInsumo').style.backgroundColor="pink";
        return;
    }else{
        
        document.getElementById('TxtObservacionesInsumo').style.backgroundColor="";
    }
    
    if(idInsumo==''){
        alertify.alert("Debe seleccionar un insumo");
        document.getElementById(idBoton).disabled=false;   
        document.getElementById(idBoton).value="Ejecutar";
    ...
    var form_data = new FormData();
        ...
        success: (data) =>{
            ...
            if(respuestas[0]=='OK'){
                ...
                document.getElementById('DivMensajes').innerHTML=respuestas[0];
                document.getElementById(idBoton).disabled=false;  
                document.getElementById(idBoton).value="Ejecutar";
            }else{
