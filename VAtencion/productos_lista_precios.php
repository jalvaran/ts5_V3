<?php
$myPage="productos_lista_precios.php";
...
include_once("Configuraciones/productos_lista_precios.ini.php");  //Clases de donde se escribirán las tablas
...
///////////////Creamos la imagen representativa de la pagina
    /////
    /////	
$css->CrearImageLink("../VMenu/Menu.php", "../images/listasprecios.png", "_self",200,200);
