...
include_once("Configuraciones/comprobantes_ingreso_anulaciones.ini.php");  //Clases de donde se escribirán las tablas
...
if(isset($_REQUEST["idAbono"])){
    ...
    if($DatosImpresora["Habilitado"]=="SI"){
        ...
        $obVenta->ImprimeComprobanteAbonoFactura($idAbono, $DatosImpresora["Puerto"], 1);
