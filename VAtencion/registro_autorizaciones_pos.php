...
include_once("Configuraciones/registro_autorizaciones_pos.ini.php");  //Clases de donde se escribirán las tablas
 ...
 */
//$Consulta=$obVenta->Query("SELECT Count(*) as Items FROM $statement");
//$Neto=$obVenta->FetchArray($Consulta);
//$Items=  number_format($Neto["Items"]);
$css->CrearTabla();
//$css->CrearFilaNotificacion("Total Items = $Items", 16);
$css->CerrarTabla();
