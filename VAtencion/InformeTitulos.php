...
print("<html>");
print("<head>");
$css =  new CssIni("Informe de Ventas de Titulos");
...
print("<body>");
    ...
    $css->CabeceraIni("Informe de Ventas de Titulos"); //Inicia la cabecera de la pagina
    ...
    /////
    /////	
    $css->CrearImageLink("../VMenu/MnuTitulos.php", "../images/infventas.png", "_self",200,200);
    ...
    $css->CrearNotificacionNaranja("GENERAR INFORME DE VENTAS DE TITULOS", 16);
    
    $VectorInformes["FormName"]="FrmInformeVentas";
    $VectorInformes["ActionForm"]="../tcpdf/examples/InformeVentasTitulos.php";
    $VectorInformes["Metod"]="post";
    $VectorInformes["Target"]="_blank";
    $VectorInformes["Titulo"]="INFORME DE VENTAS DE TITULOS";
