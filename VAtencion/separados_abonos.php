...
include_once("Configuraciones/separados_abonos.ini.php");  //Clases de donde se escribirán las tablas
...
////
///
$TotalAbonos=  number_format($obVenta->Sume("separados_abonos", "Valor", $statement));
$css->CrearNotificacionAzul("Total de Abonos: $TotalAbonos", 18);
