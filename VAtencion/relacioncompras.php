...
include_once("Configuraciones/relacioncompras.ini.php");  //Clases de donde se escribirán las tablas
...
$Consulta=$obVenta->Query("SELECT SUM(TotalAntesIVA) as Total FROM $statement");
$DatosFacturacion=$obVenta->FetchArray($Consulta);

$Total=  number_format($DatosFacturacion["Total"]);
$css->CrearTabla();

    $css->CrearFilaNotificacion(" Total Antes de IVA = $Total", 16);
