...
if( !empty($_REQUEST["Accion"]) ){
    ...
    switch ($_REQUEST["Accion"]) {
        case 1: //Dibuja las cuentas x pagar agrupadas por tercero
            ...
            $statement=" `vista_cuentasxcobrar` $Condicional ";
            ...
            $css->CrearTabla();
                ...
                $css->FilaTabla(16);
                    ...
                    print("<td colspan='2' style='text-align:center'>");
                        $link="../../general/procesadores/GeneradorCSV.process.php?Opcion=4&Tabla=vista_cuentasxcobrar_documentos";
                ...
                while($DatosCuentasXPagar=$obCon->FetchAssoc($Consulta)){
                    $css->FilaTabla(14);
                        ...
                        $css->ColTabla(utf8_encode($DatosCuentasXPagar["Tercero_Razon_Social"]), 1);
        ...
        case 2: //Dibuja las cuentas x cobrar de un tercero agrupado por documento externo            
            ...
            $statement=" `vista_cuentasxcobrar_documentos` $Condicional ";
            if(isset($_REQUEST['st'])){
        ...
        case 4: //Dibuja todas las cuentas por cobrar  
            $Tercero="";
            if(isset($_REQUEST['Page'])){
                $NumPage=$obCon->normalizar($_REQUEST['Page']);
            }else{
            ...
            $css->CrearTabla();
                ...
                $css->FilaTabla(16);
                    ...
                    print("<td colspan='2' style='text-align:center'>");
                        $link="../../general/procesadores/GeneradorCSV.process.php?Opcion=4&Tabla=vista_cuentasxcobrar_documentos&c=";
