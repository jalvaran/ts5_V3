    ...
    $css->div("", "col-md-12", "", "", "", "", "");
        $css->div("", "nav-tabs-custom", "", "", "", "", "");
            print('<ul class="nav nav-tabs">');
                print('<li class="active"><a href="#tab_1" data-toggle="tab">Pedir</a></li>');
                print('<li><a href="#tab_2" data-toggle="tab">Listado de Pedidos</a></li>');
            print('</ul>');
            $css->div("", "tab-content", "", "", "", "", "");
                $css->div("tab_1", "tab-pane active", "", "", "", "", "");   
                    $css->div("", "row", "", "", "", "", "");   
                        ...
                        $css->CerrarDiv();
                    $css->Cdiv();//Fin de la fila
                $css->Cdiv();  //Fin tab 1
                
                
                $css->div("tab_2", "tab-pane", "", "", "", "", "");  
                    $css->div("", "row", "", "", "", "", "");  
                        $css->CrearDiv("", "col-md-12", "left", $Habilita, 1); 
                            $css->fieldset("", "", "FieldDatosCotizacion", "DatosCotizacion", "", "");
                                $css->legend("", "");
                        ...
                        $css->CerrarDiv();
                    $css->Cdiv();//Fin de la fila
                $css->Cdiv();//Fin tab listado de pedidos
