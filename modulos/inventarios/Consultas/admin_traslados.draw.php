                    ...
                    print('<table class="table table-hover table-striped">');
                        ...
                        print('<tbody>');
                            while($RegistrosTabla=$obCon->FetchAssoc($Consulta)){
                                ...
                                print('<tr>');
                                    print("<td>");
                                        print('<button title="Subir Traslado" '.$disabled.' type="button" class="btn btn-success btn-sm" onclick=iniciar_subir_traslado(`'.$idItem.'`)><i class="fa fa-cloud-upload"></i></button>');
